...
#include <sys/types.h>
#include <sys/stat.h>
#include "com_tcl_tbrowser_NativeClass.h"
...
/*
 * Class:     com_tcl_tbrowser_NativeClass
 * Method:    tbrowserLoadUrlWithName
 * Signature: (Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jboolean JNICALL Java_com_tcl_tbrowser_NativeClass_tbrowserLoadUrlWithName
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_tcl_tbrowser_NativeClass_tbrowserPushKeyEventWithName
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_tcl_tbrowser_NativeClass_tbrowserDestoryWithName
 ...
 * Signature: (Ljava/lang/String;I)Ljava/lang/String;
 */
JNIEXPORT jboolean JNICALL Java_com_tcl_tbrowser_NativeClass_tbrowserSetVisible
 ...
 * Signature: (Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jboolean JNICALL Java_com_tcl_tbrowser_NativeClass_tbrowserSetActive
  (JNIEnv *env, jclass, jstring pageName){
	return JNI_TRUE;
}
